# Tienda Berlini Pastas
Un e-commerce básico para la entrega final del curso de React en Coder House.

## Descripción
Tienda Berlini Pastas es un e-commerce que permite a los usuarios ver una lista de productos y realizar compras en línea. Los productos se almacenan en Firebase y las órdenes de compra se cargan directamente desde Firebase.
